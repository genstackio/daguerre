...
func createCloudfuncNodeType() commons.PluginNodeType {
	return commons.PluginNodeType{
		...
		NodeCreator: func(ctx *commons.Ctx, lt *commons.LayerConfig, l *commons.LayerConfig, m *commons.Model) {
			...
			utils.PopulateNodes[commons.CloudfuncConfig](ctx, t, l.Name, l.Hidden, lt.Cloudfuncs, lt, l, m, 70)
			utils.PopulateNodes[commons.CloudfuncConfig](ctx, t, l.Name, l.Hidden, l.Cloudfuncs, lt, l, m, 70)
		},
