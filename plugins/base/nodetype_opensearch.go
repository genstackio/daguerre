...
func createOpensearchNodeType() commons.PluginNodeType {
	return commons.PluginNodeType{
		...
		NodeCreator: func(ctx *commons.Ctx, lt *commons.LayerConfig, l *commons.LayerConfig, m *commons.Model) {
			...
			utils.PopulateNodes[commons.OpensearchConfig](ctx, t, l.Name, l.Hidden, lt.Opensearches, lt, l, m, 150)
			utils.PopulateNodes[commons.OpensearchConfig](ctx, t, l.Name, l.Hidden, l.Opensearches, lt, l, m, 150)
		},
